...
export const questions = [
  {
    ...
    answers: [
      ...
      { text: "Панас Мирний та Іван Білик", correct: true },
  ...
  },
  {
    ...
    answers: [
      ...
      { text: "ластівки", correct: false },
      { text: "синиці", correct: false },
      { text: "шпаки", correct: false },
    ],
  },
  {
    id: 3,
    ...
    answers: [
      ...
      { text: "2 грн", correct: false },
      { text: "5 грн", correct: true },
      { text: "10 грн", correct: false },
    ],
  },
  {
    id: 4,
  ...
  },
  {
    ...
    answers: [
      ...
      { text: "Болгарія", correct: true },
      { text: "Румунія", correct: false },
      { text: "Угорщина", correct: false },
    ],
  },
  {
    id: 6,
    ...
    answers: [
      ...
      { text: "Арістотель", correct: false },
      { text: "Сократ", correct: true },
      { text: "Епікур", correct: false },
    ],
  },
  {
    id: 7,
  ...
  },
  {
    ...
    answers: [
      ...
      { text: "Аншлюс Австрії", correct: false },
      { text: "Напад Японії на Перл-Гарбор", correct: false },
      { text: "Мюнхенська угода", correct: false },
    ],
  },
  {
    id: 9,
    ...
    answers: [
      ...
      { text: "Енеїда Котляревського", correct: true },
      { text: "Кайдашева сім'я", correct: false },
      { text: "Заповіт", correct: false },
    ],
  },
  {
    id: 10,
    ...
    answers: [
      ...
      { text: "Чорне море", correct: false },
      { text: "Карибське море", correct: true },
  ...
  },
  {
    ...
    answers: [
      ...
      { text: "Аркбутан", correct: true },
      { text: "Нервюра", correct: false },
      { text: "Пілястра", correct: false },
    ],
  },
  {
    id: 13,
  ...
  },
  {
    ...
    answers: [
      { text: "Аргентина", correct: false },
      { text: "Бразилія", correct: true },
      { text: "Колумбія", correct: false },
  ...
  },
  {
    ...
    answers: [
      ...
      { text: "вітамін A", correct: false },
      { text: "вітамін B12", correct: false },
      { text: "вітамін С", correct: true },
    ],
  },
  {
    id: 16,
  ...
  },
  {
    ...
    answers: [
      ...
      { text: "Саудівська Аравія", correct: false },
      { text: "ОАЕ", correct: true },
    ],
  },
  {
    id: 20,
  ...
  },
  {
    ...
    answers: [
      ...
      { text: "ртуть", correct: true },
      { text: "Бром", correct: false },
      { text: "Цезій", correct: false },
    ],
  },
  {
    id: 22,
  ...
  },
  {
    ...
    answers: [
      ...
      { text: "Пегас", correct: false },
      { text: "Буцефал", correct: true },
      { text: "Росинант", correct: false },
    ],
  },
  {
    id: 25,
    ...
    answers: [
      ...
      { text: "Тетрациклін", correct: false },
      { text: "Аспірин", correct: false },
      { text: "пеніцилін", correct: true },
    ],
  },
  {
    id: 26,
  ...
  },
  {
    ...
    answers: [
      ...
      { text: "Полярне коло", correct: false },
  ...
  },
  {
    ...
    answers: [
      ...
      { text: "Джордж Вашингтон", correct: false },
      { text: "Томас Джефферсон", correct: false },
      { text: "Бенджамін Франклін", correct: true },
    ],
  },
  {
    id: 34,
  ...
  },
  {
    ...
    answers: [
      ...
      { text: "орігамі", correct: true },
      { text: "Сумі-е", correct: false },
      { text: "Бонсай", correct: false },
    ],
  },
  {
    id: 37,
    ...
    answers: [
      { text: "Тарас Шевченко", correct: false },
      { text: "Іван Франко", correct: false },
      { text: "Леся Українка", correct: false },
      { text: "Григорій Сковорода", correct: true },
    ],
  },
  {
    id: 38,
    ...
    answers: [
      ...
      { text: "Тайська", correct: false },
      { text: "Мейн-кун", correct: true },
      { text: "Норвезька лісова", correct: false },
    ],
  },
  {
    id: 39,
    ...
    answers: [
      ...
      { text: "Грейхаунд", correct: false },
      { text: "Салукі", correct: true },
      { text: "Бордер колі", correct: false },
    ],
  },
  {
    id: 40,
    ...
    answers: [
      ...
      { text: "Григорій Сковорода", correct: false },
      { text: "Ольга Кобилянська", correct: false },
    ],
  },
  {
    id: 41,
  ...
  },
  {
    ...
    answers: [
      ...
      { text: "Бо не можуть їх спіймати", correct: false },
      { text: "Бо вони не входять в їхній раціон", correct: false },
      { text: "Бо вони живуть на різних полюсах", correct: true },
    ],
  },
  {
    id: 43,
  ...
  },
  {
    ...
    answers: [
      ...
      { text: "Червоний, синій, жовтий", correct: true },
      { text: "Помаранчевий, фіолетовий, жовтий", correct: false },
      { text: "Бордовий, сірий, синій", correct: false },
    ],
  },
  {
    id: 45,
    ...
    answers: [
      ...
      { text: "Нирки", correct: false },
      { text: "Сечовий міхур", correct: true },
      { text: "Печінку", correct: false },
    ],
  },
  {
    id: 46,
    ...
    answers: [
      ...
      { text: "Близько 8000 - 9500", correct: false },
      { text: "Близько 1500 - 2000", correct: false },
      { text: "Близько 5000 - 6000", correct: true },
    ],
  },
  {
    id: 47,
    ...
    answers: [
      ...
      { text: "Сіра", correct: false },
      { text: "Чорна", correct: true },
      { text: "Тілесна", correct: false },
    ],
  },
  {
    id: 48,
    ...
    answers: [
      { text: "Середземне море", correct: false },
      { text: "Червоне море", correct: true },
      { text: "Мертве море", correct: false },
      { text: "Галілейське море", correct: false },
    ],
  },
  {
    id: 49,
    ...
    answers: [
      ...
      { text: "Мойсея", correct: false },
      { text: "Даниїла", correct: true },
      { text: "Іллю", correct: false },
    ],
  },
  {
    id: 50,
    ...
    answers: [
      ...
      { text: "Гавриїл", correct: true },
      { text: "Рафаїл", correct: false },
      { text: "Уриїл", correct: false },
    ],
  },
  {
    id: 51,
    ...
    answers: [
      ...
      { text: "На верблюді", correct: false },
      { text: "Пішки", correct: false },
      { text: "На ослі", correct: true },
    ],
  },
  {
    id: 52,
    ...
    answers: [
      ...
      { text: "Не кради", correct: true },
      { text: "Не чини перелюбу", correct: false },
      { text: "Шануй батька й матір", correct: false },
    ],
  },
  {
    id: 53,
    ...
    answers: [
      ...
      { text: "Єгиптянка", correct: false },
      { text: "Моавитянка", correct: true },
      { text: "Филистимлянка", correct: false },
    ],
  },
  {
    id: 54,
    ...
    answers: [
      ...
      { text: "Гонителем християн", correct: true },
      { text: "Митарем", correct: false },
      { text: "Лікарем", correct: false },
    ],
  },
  {
    id: 55,
    ...
    answers: [
      ...
      { text: "Ісус Навин та Калев", correct: true },
      { text: "Давид та Йонатан", correct: false },
      { text: "Петро та Іван", correct: false },
    ],
  },
  {
    id: 56,
  ...
  },
  {
    ...
    answers: [
      ...
      { text: "Говоріння іншими мовами", correct: true },
      { text: "Водне хрещення", correct: false },
      { text: "Членство в церкві", correct: false },
    ],
  },
  {
    id: 59,
    ...
    answers: [
      ...
      { text: "Бо їм не вистачало матеріалів", correct: false },
      { text: "Бо вони втомилися", correct: false },
      { text: "Щоб покарати їх за лінь", correct: false },
    ],
  },
  {
    id: 60,
  ...
  },
  {
    ...
    answers: [
      ...
      { text: "В піщану бурю", correct: false },
      { text: "В камінь", correct: false },
      { text: "В дерево", correct: false },
    ],
  },
  {
    id: 63,
    ...
    answers: [
      ...
      { text: "Арарат", correct: true },
      { text: "Кармел", correct: false },
      { text: "Оливна", correct: false },
    ],
  },
  {
    id: 64,
    ...
    answers: [
      ...
      { text: "Ананія та Сапфіра", correct: true },
      { text: "Захарія та Єлисавета", correct: false },
      { text: "Авраам та Сара", correct: false },
    ],
  },
  {
    id: 65,
  ...
  },
  {
    ...
    answers: [
      ...
      { text: "Псалом 91", correct: false },
      { text: "Псалом 119", correct: true },
      { text: "Псалом 1", correct: false },
    ],
  },
  {
    id: 67,
    ...
    answers: [
      ...
      { text: "В Кані Галілейській", correct: true },
      { text: "В Назареті", correct: false },
      { text: "В Капернаумі", correct: false },
    ],
  },
  {
    id: 68,
  ...
  },
  {
    ...
    answers: [
      ...
      { text: "Рахав", correct: true },
      { text: "Естер", correct: false },
      { text: "Девора", correct: false },
    ],
  },
  {
    id: 71,
    ...
    answers: [
      ...
      { text: "Акридами та диким медом", correct: true },
      { text: "Манною небесною", correct: false },
      { text: "Фініками та водою", correct: false },
    ],
  },
  {
    id: 72,
  ...
  },
  {
    ...
    answers: [
      ...
      { text: "Каменем з пращі", correct: true },
      { text: "Списом", correct: false },
      { text: "Луком і стрілою", correct: false },
    ],
  },
  {
    id: 74,
    ...
    answers: [
      ...
      { text: "Шадрах, Мешах, Авед-Него", correct: true },
      { text: "Сим, Хам, Яфет", correct: false },
      { text: "Каїн, Авель, Сет", correct: false },
    ],
  },
  {
    id: 75,
  ...
  },
  {
    ...
    answers: [
      ...
      { text: "На арфі (гуслах)", correct: true },
      { text: "На барабані", correct: false },
      { text: "На трубі", correct: false },
    ],
  },
  {
    id: 78,
